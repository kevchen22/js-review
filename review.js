...
// let newVar = age + otherAge

// console.log(newVar) 

// 5.) Use any of the variables above or create new ones and print using string interpolation

// console.log(`I am ${age} years old, but I feel like I am ${otherAge} years old.`)
...
// console.log(Math.floor(Math.random()* 2)+1)     // self notes to determine break time 
...
fruits.splice(3, 0, 'strawberry', 'kiwi', 'grapes')
// console.log(fruits)
...
const newArray = exoticFruits.concat(fruits)
